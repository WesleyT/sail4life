...
def savepound():
	file = open("/usr/share/nginx/html/totalpounds.txt", "w")
	a = int(gettotalpound())
	file.write(str(a))
	file.close()

def savedollar():
	file = open("/usr/share/nginx/html/totaldollars.txt", "w")
...
def getcharitywater():
	site = requests.get("https://my.charitywater.org/jack-duncton/sail-4-life")
